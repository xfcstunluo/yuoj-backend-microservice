...
public class JudgeServiceImpl implements JudgeService {
    ...
    public QuestionSubmit doJudge(long questionSubmitId) {
        ...
        boolean update = questionFeignClient.updateQuestionSumbitById(questionSubmitUpdate);
        if (!update) {
        ...
        update = questionFeignClient.updateQuestionSumbitById(questionSubmitUpdate);
        if (!update) {
            throw new BusinessException(ErrorCode.SYSTEM_ERROR, "题目状态更新错误");
        }
